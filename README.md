...
A data-driven decision-support framework for housing planning and policy in Ireland.

Python Status Domain Methods
...
Place source CSV files into data/raw/.
Reproduce the cleaned county-quarter panel.
Run forecasting experiments and rolling-origin evaluation.
Generate SHAP explainability outputs and scenario charts.
Export figures and tables into outputs/ for reporting.
